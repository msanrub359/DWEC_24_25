    ...
    */
    ...
    const configurarTabla=()=>{
        ...
        $('.table').DataTable({
            ...
            dom: 'Bfrtip', // Añadir el contenedor de los botones en la parte superior
            buttons: [
                {
                    extend: 'excelHtml5', // Botón para exportar a Excel
                    text: 'Exportar a Excel', // Texto que aparecerá en el botón
                                    
                    title: 'Exportar Datos' // Título que tendrá el archivo Excel
                },
                {
                    extend: 'pdfHtml5', // Botón para exportar a PDF
                    text: 'Exportar a PDF', // Texto que aparecerá en el botón
                  
                    title: 'Exportar Datos', // Título del PDF
